...
<div class="category_product_page">
    ...
    <div class="product_page_tittle d-flex justify-content-between grid_Title_page w-100">
        <div class="d-flex align-items-center">
            <p class="flex-fill">กำลังแสดง @if($show_start == $show_end) {{$show_end}} @else {{$show_start}} - {{$show_end}} @endif จากทั้งหมด {{$total_number_of_items}} สินค้า</p>
        ...
        <div class="short_by">
            <select name="sort_by" class="getFilterUpdateByIndex" id="product_short_list">
                <option disabled selected>จัดเรียงโดย</option>
