<section class="banner_part pt-5">
    <div class="container">
      <div class="row">
        ...
        @endif
        <div class="@if($menus->count()) col-xl-9 col-lg-8 @else col-xl-12 col-lg-12 @endif">
          <div class="row">
            @php
                ...
                <div class="single_banner_slider">
                  <div class="row align-items-center">
                    ...
                    " {{$slider->is_newtab == 1?'target="_blank"':''}} class="slider_img_div">
                      <img data-src="{{showImage($slider->slider_image)}}" src="{{showImage(themeDefaultImg())}}" class="lazyload" alt="{{$slider->name}}">
                    </a>
                  </div>
                </div>
                @endforeach
