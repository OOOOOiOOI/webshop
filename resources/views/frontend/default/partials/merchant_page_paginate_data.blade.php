  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="product_page_tittle d-flex justify-content-between grid_Title_page">
        <p class="text-lowercase flex-fill">{{__('กำลังแสดง')}} @if($show_start == $show_end) {{$show_end}} @else {{$show_start}} - {{$show_end}} @endif {{__('defaultTheme.out_of_total')}} {{$total_number_of_items}} {{__('common.products')}}</p>
        <div class="short_by">
