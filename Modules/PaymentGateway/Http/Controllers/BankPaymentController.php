...
class BankPaymentController extends Controller
{
    ...
    public function store($data)
    {
        ...
        if (session()->has('wallet_recharge')) {
            ...
            $transaction = $transactionRepo->makeTransaction(getParentSeller()->first_name." - Subsriction Payment", "in", "Bank Payment", "subscription_payment", $defaultIncomeAccount, "Subscription Payment", $seller_subscription, $data['deposit_amount'], Carbon::now()->format('Y-m-d'), getParentSellerId(), null, null);
